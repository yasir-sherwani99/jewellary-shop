<head>
    ...
    @if(request()->is('cart-page') || request()->is('checkout') || request()->is('wishlists') || request()->is('product/*') || request()->is('contact'))
        @vite(['resources/css/cart.css'])
    @elseif(request()->is('collections') || request()->is('collection/best-selling'))
