                        ...
                        <div class="megamenu demo">
                            <div class="menu-col">
                                ...
                                <div class="megamenu-action text-center">
                                    <a href="#" class="btn font-size-normal letter-spacing-large btn-outline-primary-2 view-all-demos"><span>View All Demos</span><i class="icon-long-arrow-right"></i></a>
                                </div><!-- End .text-center -->
                            </div><!-- End .menu-col -->
                        </div><!-- End .megamenu -->
                    </li>
