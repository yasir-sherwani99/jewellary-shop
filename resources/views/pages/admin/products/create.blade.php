...
@section('content')
    ...
    @include('layouts.partials.admin._breadcrumb', ['title' => "Add Product", 'section' => "Products", 'page' => 'Add'])
    ...
    <div class="row">
        <div class="col-sm-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" class="needs-validation" enctype="multipart/form-data" action="{{ route('admin.products.store') }}" novalidate>    
                        @csrf          
                        <div class="row mb-3">
                            <div class="col-12">
                        ...
                        <div class="row my-3">
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control" id="price" name="price" value="{{ old('price') }}" step=".01" placeholder="Enter product price" required />
                                <div class="invalid-feedback">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control" id="discount_price" name="discount_price" value="{{ old('discount_price') }}" step=".01" placeholder="Enter product discount price" />
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <input type="number" class="form-control" id="stock_qty" name="stock_qty" value="{{ old('stock_qty') }}" value="1" placeholder="Enter product stock qty" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12">
                                <label for="description" class="form-label fw-bold">Description <span class="text-danger">*</span></label>
                                <textarea class="form-control tinymce_editor" id="description" name="description" rows="4" placeholder="Product Description" required>{{ old('description') }}</textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <textarea class="form-control tinymce_editor" id="additional_info" name="additional_info" rows="4" placeholder="Product Additional Information">{{ old('additional_info') }}</textarea>
                            </div>
                        </div>
