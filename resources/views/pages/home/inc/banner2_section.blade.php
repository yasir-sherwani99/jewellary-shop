<div class="banner bg-image shadow-none mb-0" style="background-image: url(assets/images/demos/demo-25/banners/banner-5.jpg); background-color: #edeef3;">
    <div class="banner-content text-center banner-content-center px-3 p-lg-0">
        <img src="assets/images/demos/demo-25/diamond-ring.png" class="mb-2 mt-2 mx-auto w-auto" alt="" width="28" height="32" />
